(() => {
  ...
  function plugin(pluginName, className, shortHand = false) {
    ...
    $2.fn[pluginName] = function(option) {
      return this.each(function() {
        ...
        let options = $2.extend({}, className.DEFAULTS, dataOptions, typeof option === "object" && option);
        if (!data) {
  ...
  var ACFFrontendForm = class {
    ...
    setupInputs() {
      ...
      this.$form.on("keyup keydown change", selector, (e) => this.adjustHasValueClass($3(e.currentTarget)));
  ...
  var import_feather_icons2 = __toESM(require_feather());
  var $5 = window.jQuery;
  var FileInput = class {
    constructor(acfField) {
      this.acfField = acfField;
  ...
  // assets-src/acff.js
  var import_autosize = __toESM(require_autosize());
  var $7 = window.jQuery;
  var App = class {
    constructor() {
      if (typeof acf === "undefined") {
