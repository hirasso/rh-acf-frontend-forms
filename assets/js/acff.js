...
},{"./modules/autofill":2,"./modules/frontend-form":3,"./modules/image-drop":4,"./modules/maxlength":5,"autosize":7}],2:[function(require,module,exports){
(function (global){
'use strict';
...
window.acfAutoFill = function () {
  ...
  function fillField($inputs, value, fieldName) {
    ...
    $inputs.each(function (i, el) {
      ...
      var currentValue = type === 'checkbox' ? $input.prop('checked') : $input.val();
  ...
  _createClass(ACFFrontendForm, [{
    ...
    value: function handleAjaxResponse(response) {
      ...
      setTimeout(function () {
        ...
        acf.unlockForm(_this3.$form);
        acf.validation.reset(_this3.$form);
        _this3.$form.removeClass('rh-is-locked');
    ...
    value: function setupInputs() {
      ...
      this.$form.on('change', selector, function (e) {
        return _this4.maybeSubmitForm(e);
      });
    ...
    value: function adjustHasValueClass($input) {
      ...
      var enabledInputs = ['text', 'password', 'url', 'email', 'number', 'textarea', 'select', 'true_false', 'date_picker', 'time_picker', 'date_time_picker', 'oembed'];
    ...
    key: 'maybeSubmitForm',
    value: function maybeSubmitForm(e) {
 ...
 * make jQuery Plugin
 */
(0, _plugin2.default)('acfFrontendForm', ACFFrontendForm, true);

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"./plugin":6}],4:[function(require,module,exports){
(function (global){
'use strict';
...
},{"feather-icons":8}],5:[function(require,module,exports){
(function (global){
'use strict';
...
function plugin(pluginName, className) {
	...
	var dataName = '' + pluginName;
	var dataOptionsName = dataName.toLowerCase() + '-options';
	...
	$.fn[pluginName] = function (option) {
		return this.each(function () {
			...
			var dataOptions = $this.data(dataOptionsName);
			var options = $.extend({}, className.DEFAULTS, dataOptions, (typeof option === 'undefined' ? 'undefined' : _typeof(option)) === 'object' && option);
