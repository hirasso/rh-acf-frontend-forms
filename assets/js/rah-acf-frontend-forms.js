...
},{"autosize":6}],2:[function(require,module,exports){
(function (global){
'use strict';
...
var _maxInputLength = require('./max-input-length');

var _maxInputLength2 = _interopRequireDefault(_maxInputLength);
...
var ACFFrontendForm = function () {
  ...
  _createClass(ACFFrontendForm, [{
    ...
    key: 'initMaxInputLengths',
    value: function initMaxInputLengths() {
      this.$form.find('.acf-field:has(.maxlength-info)').each(function (i, el) {
        new _maxInputLength2.default($(el));
      });
    }
  }, {
    key: 'setupInputs',
    ...
    key: 'initTextAreasAutosize',
    value: function initTextAreasAutosize() {
...
},{"./max-input-length":4,"autosize":6}],3:[function(require,module,exports){
(function (global){
'use strict';
...
var ImageDrop = function () {
  ...
  _createClass(ImageDrop, [{
    ...
    value: function setupEvents() {
      ...
      this.$acfInput.on('dragover', function (e) {
        e.preventDefault();
        _this.$acfInput.addClass('is-dragover');
      });

      this.$acfInput.on('dragleave', function () {
        _this.$acfInput.removeClass('is-dragover');
      });

      this.$acfInput.on('drop', function (e) {
        e.preventDefault();
        _this.$acfInput.removeClass('is-dragover');
...
var MaxInputLength = function MaxInputLength($el) {
  _classCallCheck(this, MaxInputLength);

  var $info = $el.find('.maxlength-info');
  var $remainingCount = $el.find('.remaining-count');
  var max = parseInt($remainingCount.text(), 10);
  var $input = $el.find('.acf-input').find('textarea');
  $input.on('change cut paste drop keyup', function (e) {
    var value = $input.val();
    if (value.length > max) {
...
exports.default = MaxInputLength;
...
require('./modules/acf-autofill');

var _acfFrontendForm = require('./modules/acf-frontend-form');

var _acfFrontendForm2 = _interopRequireDefault(_acfFrontendForm);
...
window.rah.acfFrontendForm = function ($form) {
  ...
  return new _acfFrontendForm2.default($form, options);
};
  ...
  _createClass(App, [{
    ...
    value: function setupAjaxSubmit() {
      ...
      acf.addAction('submit', function ($form) {
        ...
        _this.getInstance($form).doAjaxSubmit();
      });
    }
  }, {
    key: 'getInstance',
...
},{"./modules/acf-autofill":1,"./modules/acf-frontend-form":2,"./modules/image-drop":3}],6:[function(require,module,exports){
/*!
	autosize 4.0.2
	license: MIT
